...
var (
	powdatatableDBTypes = map[string]string{`Actual24H`: `character varying`, `BTC24H`: `character varying`, `BTCPrice`: `character varying`, `Blocks24h`: `character varying`, `BlocksFound`: `character varying`, `Blocksper`: `character varying`, `CoinPrice`: `character varying`, `Coins`: `character varying`, `CurrentNetworkBlock`: `character varying`, `Currentheight`: `character varying`, `Date`: `character varying`, `Dev`: `character varying`, `Efficiency`: `character varying`, `Est`: `character varying`, `EstCurrent`: `character varying`, `EstShare`: `character varying`, `EstTime`: `character varying`, `Estimate`: `character varying`, `EstimateCurrent`: `character varying`, `EstimateLast24h`: `character varying`, `Fees`: `character varying`, `HashRate`: `character varying`, `Hashper`: `character varying`, `HashrateLast24h`: `character varying`, `Height`: `character varying`, `ID`: `integer`, `LastBlock`: `character varying`, `Lastupdate`: `character varying`, `Luck`: `character varying`, `MBTCMHFactor`: `character varying`, `Name`: `character varying`, `NetHashrate`: `character varying`, `NetworkDiff`: `character varying`, `NetworkDifficulty`: `character varying`, `NextNetworkBlock`: `character varying`, `PoolHashrate`: `character varying`, `PoolName`: `character varying`, `Port`: `character varying`, `Pos`: `character varying`, `Pow`: `character varying`, `Powid`: `character varying`, `Pphash`: `character varying`, `Ppshare`: `character varying`, `Price`: `character varying`, `Progress`: `character varying`, `RentalCurrent`: `character varying`, `Success`: `character varying`, `Time`: `character varying`, `TimeSinceLast`: `character varying`, `Total`: `character varying`, `TotalMiners`: `character varying`, `Totalkickback`: `character varying`, `Workers`: `character varying`}
	_                   = bytes.MinRead
)
