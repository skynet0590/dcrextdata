...
type Powdatatable struct {
	...
	Hashper             null.String `boil:"hashper" json:"hashper,omitempty" toml:"hashper" yaml:"hashper,omitempty"`
	Blocksper           null.String `boil:"blocksper" json:"blocksper,omitempty" toml:"blocksper" yaml:"blocksper,omitempty"`
	Luck                null.String `boil:"luck" json:"luck,omitempty" toml:"luck" yaml:"luck,omitempty"`
	Pphash              null.String `boil:"pphash" json:"pphash,omitempty" toml:"pphash" yaml:"pphash,omitempty"`
	Ppshare             null.String `boil:"ppshare" json:"ppshare,omitempty" toml:"ppshare" yaml:"ppshare,omitempty"`
	Totalkickback       null.String `boil:"totalkickback" json:"totalkickback,omitempty" toml:"totalkickback" yaml:"totalkickback,omitempty"`
	Success             null.String `boil:"success" json:"success,omitempty" toml:"success" yaml:"success,omitempty"`
	Lastupdate          null.String `boil:"lastupdate" json:"lastupdate,omitempty" toml:"lastupdate" yaml:"lastupdate,omitempty"`
	Name                null.String `boil:"name" json:"name,omitempty" toml:"name" yaml:"name,omitempty"`
	Port                null.String `boil:"port" json:"port,omitempty" toml:"port" yaml:"port,omitempty"`
	Fees                null.String `boil:"fees" json:"fees,omitempty" toml:"fees" yaml:"fees,omitempty"`
	EstimateCurrent     null.String `boil:"estimate_current" json:"estimate_current,omitempty" toml:"estimate_current" yaml:"estimate_current,omitempty"`
	EstimateLast24h     null.String `boil:"estimate_last24h" json:"estimate_last24h,omitempty" toml:"estimate_last24h" yaml:"estimate_last24h,omitempty"`
	Actual24H           null.String `boil:"actual_24h" json:"actual_24h,omitempty" toml:"actual_24h" yaml:"actual_24h,omitempty"`
	MBTCMHFactor        null.String `boil:"mbtc_mh_factor" json:"mbtc_mh_factor,omitempty" toml:"mbtc_mh_factor" yaml:"mbtc_mh_factor,omitempty"`
	HashrateLast24h     null.String `boil:"hashrate_last24h" json:"hashrate_last24h,omitempty" toml:"hashrate_last24h" yaml:"hashrate_last24h,omitempty"`
	RentalCurrent       null.String `boil:"rental_current" json:"rental_current,omitempty" toml:"rental_current" yaml:"rental_current,omitempty"`
	Height              null.String `boil:"height" json:"height,omitempty" toml:"height" yaml:"height,omitempty"`
	Estimate            null.String `boil:"estimate" json:"estimate,omitempty" toml:"estimate" yaml:"estimate,omitempty"`
	Blocks24h           null.String `boil:"blocks24h" json:"blocks24h,omitempty" toml:"blocks24h" yaml:"blocks24h,omitempty"`
	BTC24H              null.String `boil:"btc24h" json:"btc24h,omitempty" toml:"btc24h" yaml:"btc24h,omitempty"`
	Currentheight       null.String `boil:"currentheight" json:"currentheight,omitempty" toml:"currentheight" yaml:"currentheight,omitempty"`
	Total               null.String `boil:"total" json:"total,omitempty" toml:"total" yaml:"total,omitempty"`
	Pos                 null.String `boil:"pos" json:"pos,omitempty" toml:"pos" yaml:"pos,omitempty"`
	Pow                 null.String `boil:"pow" json:"pow,omitempty" toml:"pow" yaml:"pow,omitempty"`
	Dev                 null.String `boil:"dev" json:"dev,omitempty" toml:"dev" yaml:"dev,omitempty"`
	Powid               null.String `boil:"powid" json:"powid,omitempty" toml:"powid" yaml:"powid,omitempty"`
...
var PowdatatableColumns = struct {
	...
	Port:                "port",
	Fees:                "fees",
	EstimateCurrent:     "estimate_current",
	EstimateLast24h:     "estimate_last24h",
	Actual24H:           "actual_24h",
	MBTCMHFactor:        "mbtc_mh_factor",
	HashrateLast24h:     "hashrate_last24h",
	RentalCurrent:       "rental_current",
	Height:              "height",
	Estimate:            "estimate",
	Blocks24h:           "blocks24h",
	BTC24H:              "btc24h",
...
var (
	powdatatableColumns               = []string{"id", "pool_name", "hash_rate", "efficiency", "progress", "workers", "current_network_block", "next_network_block", "last_block", "network_diff", "est_time", "est_share", "time_since_last", "net_hashrate", "price", "blocks_found", "total_miners", "time", "pool_hashrate", "network_difficulty", "coin_price", "btc_price", "est_", "coins", "est_current", "date", "hashper", "blocksper", "luck", "pphash", "ppshare", "totalkickback", "success", "lastupdate", "name", "port", "fees", "estimate_current", "estimate_last24h", "actual_24h", "mbtc_mh_factor", "hashrate_last24h", "rental_current", "height", "estimate", "blocks24h", "btc24h", "currentheight", "total", "pos", "pow", "dev", "powid"}
