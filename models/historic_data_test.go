...
var (
	historicDatumDBTypes = map[string]string{`Exchangeid`: `integer`, `FillType`: `character varying`, `Globaltradeid`: `character varying`, `ID`: `integer`, `OrderType`: `character varying`, `Price`: `character varying`, `Quantity`: `character varying`, `Timestamp`: `timestamp without time zone`, `Total`: `character varying`, `Tradeid`: `character varying`}
	_                    = bytes.MinRead
)
