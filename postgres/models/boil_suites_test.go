...
func TestToOneRemove(t *testing.T) {
	t.Run("ExchangeTickToExchangeUsingExchangeTicks", testExchangeTickToOneRemoveOpExchangeUsingExchange)
}
...
func TestToManySet(t *testing.T) {
	t.Run("ExchangeToExchangeTicks", testExchangeToManySetOpExchangeTicks)
}

// TestToManyRemove tests cannot be run in parallel
// or deadlocks can occur.
func TestToManyRemove(t *testing.T) {
	t.Run("ExchangeToExchangeTicks", testExchangeToManyRemoveOpExchangeTicks)
}
